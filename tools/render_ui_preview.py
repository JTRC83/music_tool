...
def chrome(active: str) -> list[str]:
    ...
    parts = [
        ...
        *[f'<line x1="0" y1="{y}" x2="{WIDTH}" y2="{y}" stroke="#eeeeee" opacity="0.28"/>' for y in range(3, HEIGHT, 6)],
        ...
        '<circle cx="212" cy="54" r="25" fill="#f3f5de" stroke="#767c68" stroke-width="2"/>',
        '<circle cx="212" cy="54" r="17" fill="#d4ddbd" stroke="#9ba486"/>',
        '<path d="M198 41 A20 20 0 0 1 226 43" fill="none" stroke="#ffffff" stroke-width="2"/>',
        text(207, 55, "♪", 17, "700", "#25301f"),
        text(206, 68, "MT", 8, "700", "#47503c"),
        ...
        text(506, 63, "Listo", 13, "700", "#1b1b1b"),
        rect(420, 76, 280, 7, "#edf0d5", "#4f5447", 1),
        rect(420, 76, 112, 7, "#2f2f2f", "#2f2f2f", 1),
...
def render_conversion() -> str:
    ...
    parts += [
        group(42, 168, 310, 150, "1. Canciones"),
        button(62, 198, 250, "Anadir canciones"),
        button(62, 236, 250, "Quitar seleccionado"),
        button(62, 274, 250, "Vaciar lista"),
        group(374, 168, 360, 150, "2. Salida"),
        button(394, 198, 240, "Seleccionar carpeta"),
        text(394, 244, "Formato", 12, "500"),
        field(476, 224, 160, "AAC/M4A"),
        text(394, 280, "Calidad", 12, "500"),
        field(476, 260, 160, "256k"),
        text(654, 244, "Sobrescribir", 12, "400"),
        table(42, 344, 1036, 196),
        text(50, 570, "Carpeta de salida: sin seleccionar", 12, "400", "#3b3b3b"),
        *log_and_status(),
        "</svg>",
    ]
    return "\n".join(parts)

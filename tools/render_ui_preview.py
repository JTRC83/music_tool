...
def group(x: int, y: int, w: int, h: int, title: str) -> str:
    return "\n".join(
        [
            rect(x, y, w, h, PANEL_FILL, METAL_DARK, 36),
...
def chrome(active: str) -> list[str]:
    ...
    parts = [
        ...
        *[f'<line x1="0" y1="{y}" x2="{WIDTH}" y2="{y}" stroke="#eeeeee" opacity="0.28"/>' for y in range(3, HEIGHT, 6)],
        ...
        rect(926, 39, 112, 30, "#cfe7c8", "#6f9366", 15),
...
def render_editor() -> str:
    ...
    parts += [
        ...
        group(42, 276, 500, 250, "2. Metadatos"),
        *metadata_fields(64, 306),
        group(578, 276, 500, 250, "3. Edicion y exportacion"),
        *edit_fields(600, 306),
        group(42, 538, 1036, 140, "Edicion visual"),
        rect(64, 570, 992, 46, "#ffffff", "#a1a1a1", 18),
        *wave_lines(84, 600),
        rect(64, 632, 992, 34, "#ffffff", "#a1a1a1", 18),
        rect(64, 634, 130, 30, "#d9d9d9", "#d9d9d9", 12),
        rect(902, 634, 154, 30, "#d9d9d9", "#d9d9d9", 12),
        rect(130, 634, 772, 30, "#eef5ff", "#eef5ff", 12),
        '<polygon points="130,664 240,634 240,664" fill="#c7ddff"/>',
        '<polygon points="792,634 902,664 792,664" fill="#d9c7ff"/>',
        '<line x1="130" y1="650" x2="902" y2="650" stroke="#202020" stroke-width="3"/>',
        text(138, 626, "inicio", 9, "500", "#2f82df"),
        text(838, 626, "fade out", 9, "500", "#64469c"),
        *log_and_status(),
        "</svg>",
    ]
    return "\n".join(parts)
...
def render_url() -> str:
    ...
    parts += [
        ...
        group(42, 282, 1036, 125, "2. Extraccion de audio"),
        ...
        group(42, 432, 1036, 150, "Resultados"),
        rect(64, 464, 992, 32, "url(#tableHeader)", "#8f8f8f", 14),
        rect(65, 522, 990, 26, "#edf4ff", "#edf4ff", 0),
        text(82, 485, "Archivo", 12, "600", "#333"),
        text(612, 485, "Formato", 12, "600", "#333"),
        text(738, 485, "Peso", 12, "600", "#333"),
        text(858, 485, "Estado", 12, "600", "#333"),
        text(82, 526, "01 - Blue Orchid.mp3", 12, "400", "#2f3740"),
        text(612, 526, "MP3", 12, "400", "#2f3740"),
        text(738, 526, "7.8 MB", 12, "400", "#2f3740"),
        text(858, 526, "Listo", 12, "400", "#2f3740"),
        group(42, 604, 1036, 70, "Uso previsto"),
        text(66, 646, "Funcion pensada para uso personal y local: material propio, con permiso, o contenido que tengas derecho a guardar.", 12, "400", "#333333"),
        *log_and_status(),
        "</svg>",
    ]
    return "\n".join(parts)
